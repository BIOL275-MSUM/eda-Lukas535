...
Figure 3 and 4 show a general increase in the elevations and latitudes of the Phacelia Distans and Rafinesquia Neomexicana plant species over the two decades.
This result is in line with another study looking at the upward elevation and northwest range shifts of alpine plant species.
This study stated that climate change could be impacting the distribution of species by shifting their ranges to higher elevations or higher latitudes due to rising temperatures (He et al, 2019).
...
The trend being displayed in figures 3 and 4 proves that certain plant species could be needing to migrate to other places where the climate fits their needs of survival.
